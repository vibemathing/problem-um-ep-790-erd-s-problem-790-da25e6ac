...
```json
{
  ...
  "attempts": [
    {
      "artifacts": [],
      "attempt_id": "attempt:um-ep-790-erd-s-problem-790-da25e6ac-source-fidelity-01",
      "claims": [],
      "completed_at": null,
      "generator": "trusted-rolling-source-admission-v1",
      "inputs": [
        "problem-library/records/canonical-problems.jsonl",
        "https://www.unsolvedmath.com/problems/EP-790"
      ],
      "lifecycle": "planned",
      "method": "discovery",
      "objective": "Close the source-fidelity obligation before attempting the frozen root statement.",
      "obligation_graph_id": "graph:um-ep-790-erd-s-problem-790-da25e6ac-v1",
      "problem_contract_sha256": "5518fdcbd2c2fc800b5a0db4fcf07be7c631acd85fda0f58dffe74c4c02cdcc9",
      "problem_id": "problem:um-ep-790-erd-s-problem-790-da25e6ac",
      "route_id": "route:um-ep-790-erd-s-problem-790-da25e6ac-source-fidelity",
  ...
  "obligation_graphs": [
    {
      "attempt_id": "attempt:um-ep-790-erd-s-problem-790-da25e6ac-source-fidelity-01",
      "graph_id": "graph:um-ep-790-erd-s-problem-790-da25e6ac-v1",
      "obligations": [
        {
          "dependencies": [
            "obligation:um-ep-790-erd-s-problem-790-da25e6ac-statement-fidelity"
          ],
          "kind": "root_claim",
          "obligation_id": "obligation:um-ep-790-erd-s-problem-790-da25e6ac-root",
          "statement": {
            "formal_declaration": null,
            "language": "en",
            "text": "Let $l(n)$ be maximal such that if $A\\subset\\mathbb{Z}$ with $\\lvert A\\rvert=n$ then there exists a sum-free $B\\subseteq A$ with $\\lvert B\\rvert \\geq l(n)$ - that is, $B$ is such that there are no solutions to $ a_1=a_2+\\cdots+a_r $ with $a_i\\in B$ all distinct. Estimate $l(n)$. In particular, is it true that $l(n)n^{-1/2}\\to \\infty$? Is it true that $l(n)< n^{1-c}$ for some $c>0$?"
          },
          "statement_sha256": "a62e1a8f9072787d308b0cdc300f0422a67578b92b46f07dd30c4bf95d7397a9"
        },
        {
          "dependencies": [],
          "kind": "definition",
          "obligation_id": "obligation:um-ep-790-erd-s-problem-790-da25e6ac-statement-fidelity",
          "statement": {
            "formal_declaration": null,
            "language": "en",
      ...
      "root_obligation_id": "obligation:um-ep-790-erd-s-problem-790-da25e6ac-root",
      "route_id": "route:um-ep-790-erd-s-problem-790-da25e6ac-source-fidelity"
    }
  ],
  "problem_contract": {
    ...
    "sources": [
      {
        ...
        "source_record_id": "unsolvedmath-ep-790-06f149f48a4f",
        "url": "https://www.unsolvedmath.com/problems/EP-790"
      },
      {
        "retrieved_at": "2026-09-02T00:06:43Z",
